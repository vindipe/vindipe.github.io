...
export const recentWorks: RecentWork[] = [
  ...
  },
  {
    ...
    desc: "Public repository containing normalized and entropy-derived digital-asset datasets for the DLT '25 EB-index study, plus reproducibility material for regenerating the main figures.",
  ...
  },
  {
    ...
    desc: "Master's thesis project on a decentralized accounting and document-management system integrating blockchain transactions, Solid Pods, QR-code interaction, and eBill-inspired workflows, now linked to a modernized local-demo repository.",
